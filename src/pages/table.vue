<template>
    <div>
        ...
        <div class="currHeight" style="margin-top: 10px">
            <el-table :data="table" height="100px" style="width: 100%" border>
              <el-table-column v-for="(data,index) in table" prop="name" label="日期" :key="index" show-overflow-tooltip></el-table-column>
                <!--<el-table-column prop="date" label="日期" ></el-table-column>-->
                <!--<el-table-column prop="name" label="姓名" ></el-table-column>-->
                <!--<el-table-column width="190" prop="address" label="地址" class-name="left" show-overflow-tooltip></el-table-column>-->
                <!--<el-table-column label="操作" width="190">-->
                    <!--<template slot-scope="scope">-->
                        <!--<el-button  size="mini">设置2</el-button>-->
                    <!--</template>-->
                <!--</el-table-column>-->
            </el-table>
          <el-pagination
...
export default {
    ...
    data(){
        return {
            ...
            tab: '0',
            table: [
                {date: '2016-05-02', name: '王小虎王小虎王小虎王小虎王小虎王小虎王小虎', address: '上海市普陀区金沙江路 1518 弄' },
