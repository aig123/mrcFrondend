<template>
    <div>
        <div class="searchForm">
            ...
            <div class="searchForm--item">
                <div class="searchForm--item__content">
                    <el-input v-model="input" suffix-icon="el-icon-search" placeholder="请输入教师姓名或简拼" size="small"></el-input>
                </div>
            </div>
        ...
        <div class="currHeight" style="margin-top: 10px">
            <el-table :data="table" height="100%" style="height: 100%" border>
